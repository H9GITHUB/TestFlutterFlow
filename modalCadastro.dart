...
import 'modal_cadastro_model.dart';
export 'modal_cadastro_model.dart';
...
class ModalCadastroWidget extends StatefulWidget {
  ...
  /// carregar tarefas antes de fechar
...
class _ModalCadastroWidgetState extends State<ModalCadastroWidget> {
  late ModalCadastroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCadastroModel());

    _model.titulodatarefaTextController ??= TextEditingController();
    _model.titulodatarefaFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  Container(
                    width: double.infinity,
                    child: TextFormField(
                      controller: _model.titulodatarefaTextController,
                      focusNode: _model.titulodatarefaFocusNode,
                      autofocus: false,
                      enabled: true,
                      obscureText: false,
                      ...
                      validator: _model.titulodatarefaTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  Container(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await TarefasTable().insert({
                          'titulo': _model.titulodatarefaTextController.text,
                          'descricao': _model.descricaoTextController.text,
                          'data_vencimento': supaSerialize<DateTime>(
                              dateTimeFormat("d/M/y", _model.datePicked) ==
                                          null ||
                                      dateTimeFormat(
                                              "d/M/y", _model.datePicked) ==
                        ...
                        safeSetState(() {
                          _model.titulodatarefaTextController?.clear();
